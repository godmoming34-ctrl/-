...
void showInstructions() {
    ...
    cout << "  -------------------\n";
    cout << "  go <номер>   - перейти в локацию с указанным номером\n";
    cout << "  open         - решить головоломку текущей локации\n";
    cout << "  look         - посмотреть текущую локацию\n";
    cout << "  map          - показать карту всех локаций\n";
    cout << "  help         - показать эту справку\n";
    cout << "  exit         - выйти из игры\n";
    cout << "\n";
    cout << "  НОМЕРА ЛОКАЦИЙ:\n";
    cout << "  ---------------\n";
    ...
    cout << "\n";
    cout << "  ПОДСКАЗКА ПО ПРОХОЖДЕНИЮ:\n";
    cout << "  -------------------------\n";
    cout << "  1. Перейдите в локацию 1 (go 1)\n";
    cout << "  2. Решите математический пример\n";
    cout << "  3. Перейдите в локацию 2 (go 2)\n";
    cout << "  4. Введите слово 'labirint'\n";
    cout << "  5. Перейдите в локацию 3 (go 3)\n";
    cout << "  6. Выберите вариант 2 (направо)\n";
    cout << "  7. ПОБЕДА!\n";
    cout << "\n";
    cout << "========================================\n";
    cout << "  ВВЕДИТЕ 'help' В ЛЮБОЙ МОМЕНТ ДЛЯ СПРАВКИ\n";
    cout << "========================================\n";
}
