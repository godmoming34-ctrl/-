...
// ============================================================
// ФУНКЦИЯ ПОДСЧЕТА ВРЕМЕНИ В ИГРЕ
// ============================================================
string getGameTime() {
    time_t currentTime = time(0);
    int seconds = (int)difftime(currentTime, startTime);
    int minutes = seconds / 60;
    seconds = seconds % 60;

    string result = "";
    if (minutes > 0) {
        result += to_string(minutes) + " мин ";
    }
    result += to_string(seconds) + " сек";
    return result;
}
...
void showInstructions() {
    ...
    cout << "  6. Смотрите статистику командой 'stats'\n";
    cout << "\n";
